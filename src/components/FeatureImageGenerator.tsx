...
const FeatureImageGenerator = ({ 
  ...
  return (
    <div className="space-y-4 h-full">
      {/* Show API input and generate button only if no image generated yet */}
      {!generatedImage && (
        <>
          {showApiInput && (
      ...
      <div className="relative">
        ...
        {/* Show regenerate button only when image is generated */}
        {generatedImage && (
          <Button
            onClick={resetToGenerate}
            size="sm"
            variant="secondary"
            className="absolute top-2 right-2 bg-white/90 hover:bg-white text-gray-700 shadow-sm"
          >
