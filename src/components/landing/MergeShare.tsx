import { Lock, GitMerge, Send, X, Check } from "lucide-react";
    ...
    <div className="w-full max-w-sm overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-[0_20px_60px_-20px_rgba(0,0,0,0.25)]">
      ...
      <div className="px-5 py-5">
        ...
        <div className="mt-1.5 flex items-center gap-2 rounded-lg border border-gray-200 px-3 py-2">
          ...
          <span className="text-[13.5px] text-gray-700">jordan@aperture.co</span>
        </div>
        ...
        <div className="mt-4 flex items-start gap-2 rounded-lg bg-[#F7FAF8] px-3 py-2.5">
          ...
          <p className="text-[12.5px] leading-snug text-gray-600">
            They sign in as themselves and see only emails and meetings between the
            two of you. A grant, not an export. Revocable any time.
          </p>
        </div>
...
export default function MergeShare() {
  return (
    <section id="share" className="scroll-mt-24 px-4 py-20 md:py-28">
        ...
        <div>
          <FadeIn>
            <h2 className="font-display text-3xl font-semibold tracking-tight text-gray-900 md:text-[2.5rem] md:leading-[1.12]">
              Your team's memory,
              <br className="hidden sm:block" /> without the CRM.
            </h2>
          </FadeIn>
          ...
          <div className="mt-8 space-y-6">
            <FadeIn delay={0.06}>
              <div className="flex gap-3.5">
                <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-700 shadow-sm">
                  <GitMerge className="h-4 w-4" strokeWidth={1.9} />
                </span>
                <div>
                  <h3 className="font-display text-[16px] font-semibold text-gray-900">Merge</h3>
                  <p className="mt-1 text-[14.5px] leading-relaxed text-gray-500">
                    Two of you know the same person? Merge capsules and both of you
            ...
            <FadeIn delay={0.12}>
              <div className="flex gap-3.5">
                ...
                <div>
                  <h3 className="font-display text-[16px] font-semibold text-gray-900">Share</h3>
                  <p className="mt-1 text-[14.5px] leading-relaxed text-gray-500">
                    Send the capsule to the other side. They sign in as themselves
                    and see only emails and meetings between the two of you. A grant,
                    not an export, revocable any time.
                  </p>
                </div>
              </div>
            </FadeIn>
