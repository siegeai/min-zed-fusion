      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => <div key={index} className="">
              ...
              <div className="relative h-48 overflow-hidden bg-gray-50 border-10 border-green-200/60 rounded-lg">
                <img src={feature.image} alt={feature.title} className="w-full h-full rounded-md object-contain" />
              </div>
