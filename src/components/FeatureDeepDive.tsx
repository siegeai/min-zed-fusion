...
const FeatureDeepDive = () => {
  ...
  const features = [{
    ...
    prompt: "Render a team inbox with avatars, assignments, and real-time presence. Each email/task card shows a status (e.g., 'Drafting by Alex'), collaborator avatars, and a comment thread on the side. Show a task labeled 'Customer Q3 pricing email' being co-edited by two teammates, with a 'shared draft' icon. Include 'Assign,' 'Comment,' and 'Share thread' actions. Collaboration-forward. Clean, high-trust interface — think Figma or Linear."
  }, {
              ...
              <div className="relative h-48 overflow-hidden bg-gray-50 border-transparent bg-gradient-to-r from-emerald-200 via-green-300 via-lime-400 via-emerald-500 via-green-600 via-teal-500 via-emerald-400 via-lime-300 to-green-200 rounded-sm p-[3px]">
                <div className="w-full h-full bg-gray-50 rounded-sm overflow-hidden relative">
                  ...
                  <FeatureImageGenerator
                    ...
                    currentImageUrl={generatedImages[index]}
                  />
                </div>
              </div>
