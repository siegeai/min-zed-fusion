    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
              <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 text-base font-normal">
      ...
      <div className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto font-light">
            Join thousands of teams already using min to streamline their external communication workflow.
          </p>
          <Button size="lg" variant="secondary" className="bg-white text-blue-600 hover:bg-gray-50 px-8 py-3 text-base font-normal">
