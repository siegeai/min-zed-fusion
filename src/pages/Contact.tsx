  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="min. is the AI teammate that does the little things. Get in touch with min. for sales, support, partnerships, investors, press. Email hello@getmin.ai, average reply under 2 hours."
        />
