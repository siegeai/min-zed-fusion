  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="min. is a dedicated AI engineer for your repos. Get in touch for sales, support, partnerships, investors, press. Email hello@getmin.ai, average reply under 2 hours."
        />
