  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-[#FAFAF9] text-gray-900 font-sans antialiased overflow-x-hidden">
        ...
        <main>
          {/* Hero */}
          <section className="relative pt-28 md:pt-44 pb-16 overflow-hidden">
            <HeroAmbientGlow />
          ...
          <section className="py-16">
            <div className="max-w-5xl mx-auto px-6">
              ...
              <h2 className="text-gray-900 text-3xl md:text-4xl font-semibold tracking-[-0.02em] text-center mb-12">
                Four kinds of people.
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {TRAITS.map((t) => (
                  <div key={t.title} className={`${CARD_SURFACE} p-6`}>
                    <div className="mb-4">
          ...
          <section className="py-16">
            <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className={`${CARD_SURFACE} p-7`}>
                <h3 className="text-gray-900 text-lg font-semibold tracking-[-0.01em] mb-5">
                  Benefits
                </h3>
              ...
              <div className={`${CARD_SURFACE} p-7 flex flex-col`}>
                <div className="mb-4">
                  <IconTile Icon={Zap} size="sm" tint="amber" filled />
                </div>
                <h3 className="text-gray-900 text-lg font-semibold tracking-[-0.01em] mb-3">
                  How we work
                </h3>
                <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <section className="pb-24 pt-8">
            <div className="max-w-2xl mx-auto px-6 text-center">
              <h3 className="text-gray-900 text-2xl md:text-3xl font-semibold tracking-[-0.02em] mb-4">
                Don't overthink it.
              </h3>
